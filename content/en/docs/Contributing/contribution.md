...
Thanks for considering to contribute to Eclipse Velocitas. We really appreciate the time and effort you want to spend helping to improve Eclipse Velocitas.
...
- From the velocitas-docs/hugo/hugo directory run the command **hugo server** visit localhost:1313 to see the rendered static site.
