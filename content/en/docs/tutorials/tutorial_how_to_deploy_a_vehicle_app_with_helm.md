...
The app port is configurable as `vehicleAppPort` inside your `.velocitas.json` variables section. If not set the default value is [50008](https://github.com/eclipse-velocitas/devenv-runtimes/blob/main/manifest.json#L192)
{{% /alert %}}

Additionally a sample Helm chart for the runtime can be generated by executing `velocitas exec runtime-k3d generate-helm` inside a running DevContainer. The `helm` directory will be generated to the root of your repository.
This sample chart is generated by using the configuration of the [`runtime.json`](https://github.com/eclipse-velocitas/devenv-runtimes/blob/main/runtime.json) inside the [`devenv-runtimes`](https://github.com/eclipse-velocitas/devenv-runtimes) package.
